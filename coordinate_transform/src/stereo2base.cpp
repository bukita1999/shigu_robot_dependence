...
void callback(const nav_msgs::OdometryConstPtr &msg)
{
    ...
    r = tf::createQuaternionMsgFromRollPitchYaw(0, -3.1415926 / 2, 3.1415926); //绕x逆时针旋转90度
...
{
    //初始化节点
    ros::init(argc, argv, "stereo2base");
    //声明节点句柄
    ros::NodeHandle nh;
    //发布话题
    enu_pub = nh.advertise<nav_msgs::Odometry>("/stereo_odometry_base", 10);
    //订阅话题
